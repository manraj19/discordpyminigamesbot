...
async def help(ctx):
    ...
    embed.add_field(name="Games", value="`dino`, `rockpaperscissors`, `connect4`, `tictactoe`, `fight`, `flagle`, `mathematics`, `blackjack`, `8ball`, `truthordare`, `riddle`, `race`", inline=False)
...
async def leaderboard(ctx, game: str):
    ...
    if game not in supported_games:
        await ctx.send("Supported leaderboards: dino, flagle, fight, connect4, rockpaperscissors, tictactoe.")
        return
...
TOP_GG_TOKEN = os.environ.get("TOPGG_TOKEN", "")
